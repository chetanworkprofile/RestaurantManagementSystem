...
namespace RestaurantManagementSystem.Services
{
    public interface IOrderService
    {
        ...
        //public Object GetOrdersAsChef(Guid? orderId, string loggedInUserId, string token, string? status, string OrderBy, int SortOrder, int RecordsPerPage, int PageNumber, out int code);
    }
}
